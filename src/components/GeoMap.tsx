...
export function GeoMap() {
  ...
  return (
    <Card className="col-span-2 hover:shadow-lg transition-all duration-300">
      ...
      <CardContent>
        <div className="aspect-[16/9] relative rounded-lg overflow-hidden bg-white">
          <iframe
        ...
        <div className="mt-4">
          ...
          <div className="h-2 bg-gradient-to-r from-custom-purple-50 to-custom-purple-300 rounded-full mt-1" />
        </div>
      </CardContent>
    </Card>
  );
